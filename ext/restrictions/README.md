...
Условие проверят наличие или отсутствие значения в указанной переменной или отсутствие самой переменной.
...
Условие проверят наличие или отсутствие файла, любого типа или какого то определенного.
...
Условие проверят наличия Юзернейма (@username) у пользователя 
...
Условие проверят где была запущена реакция.
...
Условие проверят является ли пользователь участником списка пользователей
...
Условие проверят является ли пользователь админом бота
...
Условие проверят является ли пользователь участником чата/канала. 
...
Условие проверят является ли пользователь админом в чате
...
Условие проверят была ли пересылка сообщения
...
Условие проверят кто отправил сообщение бот или нет.
...
Условие проверят запущено ли Отложенное действие (далее ОД) для пользователя.
...
Условие проверят установленный язык пользователя бота.
...
Условие проверят закрыто ли голосование в опросе
