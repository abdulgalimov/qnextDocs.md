...
## [**ProfileValue**](/docs-test/admin/profile/profilevalue) 
...
* Установить язык можно с помощью реакциии [setLanguage](/docs-test/admin/other/reactions/setuserlanguage)
