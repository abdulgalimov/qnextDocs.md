...
Макрос `!{date}` - макрос позволяющий вставить в текст дату.
...
Параметр `when` указывает какую дату отобразить: сейчас, завтра, определенная дата... В зависимости от значения when, макрос может принимать различные дополнительные параметры. Значения параметры when могут быть следующими:
* [now](#now)
* [tomorrow](#tomorrow)
* [yesterday](#yesterday) 
