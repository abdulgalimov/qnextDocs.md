...
## Google
* [**googleWrite** ](/docs-test/ext/reactions/googlewrite)- записать в гугл-таблицу
## Trello
...
* [trelloCreateCardAttachment](/docs-test/ext/reactions/trellocreatecardattachment)
 ...
 * [**weblinkRedirect**](/docs-test/ext/reactions/redirecturl) - перенаправление на другой адрес
 ...
 * [**DynamicVarDel** ](/docs-test/ext/reactions/cleardynamicvariable)- Удалить значение динамической переменной
 * [**loadDynamicVar** ](/docs-test/ext/reactions/readdynamicvariable)- Прочитать динамическую переменную
 * [**DynamicVarSet** ](/docs-test/ext/reactions/writedynamicvariable)- Записать динамическую переменную
 ## Контент
 ...
 * [**profilesCount** ](/docs-test/ext/reactions/profilescount)- посчитать количество профилей
 ## Рассылка
 * [**newsletterCancel** ](/docs-test/ext/reactions/newslettercancel)- Отменить рассылку
 * [**newsletterRevoke** ](/docs-test/ext/reactions/newsletterrevoke)- Аннулировать рассылку
 * [**newsletterStart**](/docs-test/ext/reactions/newsletterstart) - Начать рассылку
