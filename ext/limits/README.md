...
| Резервирование @username после смены | Нет информации                                                                  |      30-60 мин      |      30-60 мин      |
...
| Тип                 | Описание                                                              | Базовое  |     Премиум      |
|---------------------|-----------------------------------------------------------------------|:--------:|:----------------:|
| Длительность сторис | Максимальная длительность, на которую можно записать сторис           | 0 секунд |    60 секунд     |
| Время публикации    | Период времени в течение которого будет доступен сторис в общей ленте |    0     | 6/12/24/48 часов |