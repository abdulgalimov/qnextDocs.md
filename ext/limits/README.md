...
| Создание геочатов | Количество геочатов которые может создать аккаунт | 0-5 | 0-5 |
...
| Участие в геочатах | Количество геочатов в которых можно состоять. *Верхний потолок точно неизвестен | до 10 | до 30 |
...
| Расшифровка голосовых | перевод голосового в текст | недоступно | до 5 минут |
...
| Тип | Описание | Базовое | Премиум |
| --- | --- | :---: | :---: |
| Открытие | Количество участников для открытия топиков | 200 | 200 |
