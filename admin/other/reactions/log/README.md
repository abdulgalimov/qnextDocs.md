...
_Количество реакций log не ограничено на триггер_
...
Раздел доступный внутри реакции работающих с пользователем (tale...): _takeUsers/takeReplyUsers/takeAuthorUsers_
...
— _${formResult.values.number}_ - содержит значение отдельного поля number.
...
— '7': _messageAutoDeleteTimerChanged_

— '8': _voiceChatStarted_

— '9': _voiceChatEnded_

— '10': _voiceChatParticipantsInvited_

— '11': _voiceChatScheduled_
