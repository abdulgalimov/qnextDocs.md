...
[Ссылка](https://qnext.app/docs/admin/forms/#%D1%80%D0%B5%D0%B7%D1%83%D0%BB%D1%8C%D1%82%D0%B0%D1%82%D1%8B)
...
Кнопки поля имеют следующие настройки:

![](./21.jpg)

* **Баллы** - Указание вес (цену, балл) кнопки. Балл всех нажатих кнопок будет доступен в триггере финиша в переменной: _${formData.points}_
...
* **Баллы** - позволяет указать вес (цену, балл) кнопки. Балл всех нажатих кнопок будет доступен в триггере финиша в переменной: _${formData.points}_
...
Пример: 
* Если пользователь ввел число до 20 - результат 1
* если пользователь ввел число больше 20 - результат 2
