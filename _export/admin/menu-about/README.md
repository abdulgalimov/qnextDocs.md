...
* [Настройки раздела](#настроики-раздела)
...
* [Значения](#значения)
```plain
[_Вернуться к разделу: Настройка_](#настроика)
```
### Описание
...
![](./6.png)
```plain
[Вернуться к разделу:  **Настройка**](#настроика)
```
### Ограничения
